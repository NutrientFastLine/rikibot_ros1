...
void rikibot::writeSpeed(double RobotV, double YawRate)
{
...
bool rikibot::spinOnce(double RobotV, double YawRate)
{
    // 下发机器人期望速度
...
unsigned char rikibot::getCrc8(unsigned char *ptr, unsigned short len)
{
	unsigned char crc;
	unsigned char i;
	crc = 0;
