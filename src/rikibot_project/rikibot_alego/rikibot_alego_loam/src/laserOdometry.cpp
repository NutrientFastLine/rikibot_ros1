...
void LaserOdometry::onInit()
{
  ...
  sub_segmented_info_ = nh_.subscribe<cloud_msgs::cloud_info>("/seg_info", 10, boost::bind(&LaserOdometry::segInfoHandler, this, _1));
...
void LaserOdometry::segInfoHandler(const cloud_msgs::cloud_infoConstPtr &msg)
{
  m_buf_.lock();
