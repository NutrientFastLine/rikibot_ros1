...
from riki_msgs.msg import Blue_connect
from riki_msgs.msg import Bluetooth
...
class Getbluetoothdata:
	def __init__(self):
		...
		os.system("rostopic pub -1 blue_connect riki_msgs/Blue_connect -- '1'")
	...
	def controllerLoss(self):
                os.system("rostopic pub -1 blue_connect riki_msgs/Blue_connect -- '0'")
		#self.blue.connect_stats = 0
		#for i in range(1):
			#self.Blue_contorl_pub.publish(self.blue.connect_stats)
			#rospy.sleep(1)
		#rospy.loginfo('RIKIBOT Bluetooth is lost connected')

if __name__ == '__main__':
        print('                                                              ')
	print('Try connecting to RIKIBOT Bluetooth,waiting for Bluetooth data')
        rospy.init_node('rikibot_connect_bluetooth')
