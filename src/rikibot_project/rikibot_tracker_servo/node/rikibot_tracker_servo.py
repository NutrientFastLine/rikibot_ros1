...
class RikibotTrackerServo():
    def __init__(self):
        rospy.init_node('rikibot_tracker_servo_node', log_level=rospy.INFO)
        r = rospy.Rate(20)
    ...
    def shutdown(self):
        ...
        rospy.logwarn("now will shutdown rikibot tracker servo ...")

if __name__ == '__main__':
    try:
        TrackerServo = RikibotTrackerServo()
        rospy.spin()
    except Exception, e:
