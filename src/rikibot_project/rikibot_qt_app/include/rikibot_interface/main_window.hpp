/**
 * @file /include/rikibot_interface/main_window.hpp
 *
 * @brief Qt based gui for rikibot_interface.
 *
 * @date November 2010
 **/
#ifndef rikibot_interface_MAIN_WINDOW_H
#define rikibot_interface_MAIN_WINDOW_H
...
public:
    ...
    image_transport::Subscriber subscriber1_;
    void callbackImage(const sensor_msgs::Image::ConstPtr& msg);
    void callbackImage1(const sensor_msgs::Image::ConstPtr& msg);
    ...
    void selectTopic1(const QString& topic);
...
private slots:
    ...
    void onTopicChanged1(int index);
...
#endif // rikibot_interface_MAIN_WINDOW_H
